...
Das [Mädchen](persona_girl.md) ist faul und kann kein [Garn](piece_yarn.md) erzeugen, doch die [Befehlsgewalt](position_ruler.md) der [Königin](persona_queen.md) zwingt es als [Fleißgezwungene](position_captive.md) in die [Spinnstube](place_spin-chamber.md) vor drei Kammern voll [Flachs](piece_flax.md). Es sinnt nicht auf Fleiß, nur auf den Ausweg: die [Täuschung](process_deception.md) soll die fremde Hand die Arbeit tun lassen und zugleich die Mühsal für alle Zeit von ihm nehmen. Die drei [Gehilfinnen](position_helpers.md), durch das ewige Spinnen verwachsen, sind ihm Werkzeug und Beweis zugleich: ihre Mißgestalt am Festtisch ist der Schlüssel zur [Befreiung](process_liberation.md), denn an ihr soll der [Prinz](persona_prince.md) selbst das Verbot des [Spinnrads](piece_spinning-wheel.md) aussprechen.
...
- Der Plan rechnet mit der Hilfsbereitschaft der drei [Spinnerinnen](persona_spinners.md), denen die Einladung zur Hochzeit Lohn genug ist, und mit ihrer Kunst, den ganzen [Flachs](piece_flax.md) in Garn zu verwandeln.
- Er rechnet mit der Leichtgläubigkeit der [Königin](persona_queen.md), die das fremde Werk für das des Mädchens nimmt.
- Er rechnet darauf, daß der Anblick der durch das Spinnen Verwachsenen den [Prinzen](persona_prince.md) selbst zum Verbot des [Spinnrads](piece_spinning-wheel.md) bewegt, sodass die Mühsal nicht nur einmal, sondern auf Lebenszeit von der Braut genommen ist.
