...
# Plan: die List der Braut

## Taxonomy

Ein Überlebensplan im Mörderhaus: das Vorhaben der [Müllertochter](persona_daughter.md), die ihr Grauen vor dem [Räuberbräutigam](persona_bridegroom.md) nicht in Furcht erstarren lässt, sondern in kühle Wachsamkeit verwandelt. Sie geht in die Höhle des Mörders, um sie als [Braut](position_bride.md) lebend wieder zu verlassen und ihn als [Mörder](position_monster.md) zu überführen.

## Owner

- Owner: [Müllertochter](persona_daughter.md)
...
- Der Plan rechnet mit dem stillen [Vorgefühl der Gefahr](process_dread.md): die Braut vertraut ihrem Grauen mehr als den Versprechen des [Müllers](persona_miller.md).
- Er rechnet damit, dass List den Mörder schlägt, wo Kraft ihn nicht schlägt: das Schweigen hinter dem [Fass](piece_cask.md) bewahrt das Leben, das ein Schrei verspielt hätte.
- Er rechnet damit, dass der [Finger mit Ring](piece_ring_finger.md) zum unwiderlegbaren Zeugnis wird, das den als „Traum" erzählten Mord zur Wahrheit macht und den [Mörder](position_monster.md) der Gerechtigkeit ausliefert.
