...
- **the production ([play_der_judenstein.md](play_der_judenstein.md))**: the root that chains the three plots and casts the company.
- **the child ([persona_kind.md](persona_kind.md), [position_victim.md](position_victim.md))**: Anderl; encoded purely as the victim of the betrayal, never as a cult figure.
- **the father ([persona_vater.md](persona_vater.md), [position_betrayer.md](position_betrayer.md))**: the agent of the sale; the betrayal is his, not a communal or racial act.
- **the mother ([persona_mutter.md](persona_mutter.md), [position_mourner.md](position_mourner.md))**: the witness through the blood-sign; the figure who recovers the child.
- **the executioners ([persona_schergen.md](persona_schergen.md), [position_executioners.md](position_executioners.md))**: encoded purely by structural function as the killers the father's sale enables; no ethnic, religious, or ritual identity.
- **the instruments ([piece_laubgeld.md](piece_laubgeld.md), [piece_blutstropfen.md](piece_blutstropfen.md), [piece_stein.md](piece_stein.md))**: the worthless coin, the three blood-drops, and the killing stone.
- **the stages ([place_wald.md](place_wald.md), [place_kirche.md](place_kirche.md))**: the forest of the killing and the church where the child is recovered.
- **the engines ([process_betrug.md](process_betrug.md), [process_martyrium.md](process_martyrium.md))**: the sale-betrayal and the killing that follows it.
