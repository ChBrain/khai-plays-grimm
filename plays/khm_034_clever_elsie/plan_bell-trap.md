...
1. [Hans](persona_hans.md) findet die im [Kornfeld](place_field.md) eingeschlafene [Else](persona_elsie.md), die statt zu schneiden den süßen [Brei](piece_porridge.md) verzehrt hat.
2. Er wirft der Schlafenden das [Glockennetz](piece_net_bells.md), ein Vogelstellernetz voller Schellen, über den Leib, sodass jeder Schritt sie verrate.
3. Er kehrt allein heim, verriegelt die Tür des [Wohnhauses](place_home.md) und lässt die [Fremde](position_stranger.md) draußen, damit das Klingeln sie bei sich selbst befrage.
4. Er wartet, dass die erwachende [Else](persona_elsie.md) sich aus eigener Verwirrung zur Vernunft fasse und als gebesserte Frau wiederkehre.
