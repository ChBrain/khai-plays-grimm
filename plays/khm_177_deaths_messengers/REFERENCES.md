...
Jacob and Wilhelm Grimm's _Kinder- und Hausmärchen_ (1812-1857), tale KHM 177, in the definitive 7th edition of 1857.

| Source             | Key Work / Event                   | Scope                                                                |
| ------------------ | ---------------------------------- | -------------------------------------------------------------------- |
| **Brothers Grimm** | _Kinder- und Hausmärchen_, KHM 177 | The canonical tale of Death, the giant, and the messengers of dying. |

## Restrictions

What the production refuses to model, and to whom it delegates.

- **Anatomy of the ailments**: fever, gout, and toothache are treated as signs and signals, not as clinical conditions to be diagnosed or cured.
- **Cosmology of Death**: Death's nature and his brotherhood with Sleep are taken as given allegory, not as a metaphysics to be argued.
...
- **the production ([play_deaths_messengers.md](play_deaths_messengers.md))**: the root that chains the five plots and casts the company.
- **the reaper ([der Tod](persona_death.md), [der Schnitter](position_reaper.md))**: Death, overthrown once yet keeping his word.
